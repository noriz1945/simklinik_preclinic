  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="form-group">
        ...
        <form name="form1" method="post" action="<?php echo base_url('nurse_station/cari_pasien_poli') ?>"
          class="form-inline">
          <div class="form-group">
    ...
    <div class="table-responsive">
      ...
      ?>
          <tr class="table-row" data-href="<?php echo site_url("soap/epoli/pasien_list/"."$id_reg/".$id_pasien) ?>">
            ...
            <td>
              <a href="#" onclick="javascript:add_fisik('<?php echo $id_reg; ?>')" <?php echo $add; ?>><img
                  src="<?php echo base_url('assets/img/plus.png'); ?>" alt="View"></a>

              <a href="#" onclick="javascript:edit_fisik('<?php echo $v['id_reg']; ?>')" <?php echo $update; ?>><img
                  src="<?php echo base_url('assets/img/tulis.png'); ?>" alt="Update"></a>&nbsp;&nbsp;&nbsp;&nbsp;

              <a href="#" onclick="javascript:delete_fisik('<?php echo $v['id_reg']; ?>')" <?php echo $delete; ?>><img
                  src="<?php echo base_url('assets/img/delete.png'); ?>" alt="Delete"></a>
            </td>
            <td>
            ...
            <td>
              <a <?php echo $sehat; ?>  href="#" onClick="javascript:void window.open('<?php echo base_url('surat_sehat/surat_sehat_print_byidreg/' . $v['id_reg'].'/'.$v['id_dokter']) ?>','1541221517736','width=1024,height=600,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;"><img src="<?php echo base_url('assets/img/print1.png'); ?>" alt="View"></a>&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
          </tr>
          <?php
        $i++;
