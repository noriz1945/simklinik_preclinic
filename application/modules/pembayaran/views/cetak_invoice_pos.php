...
<html>
    ...
    <br>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tbody>
		    ...
		    <tr>
		      <td align="center"><strong><span lang="EN-US">LYND CLINIC</span></strong></td>
	      </tr>
		    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td width="1" rowspan="2" align="center"><?php echo $data_inv_header->invdate ?></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      ...
      <td align="center">=</td>
      <td align="center">Rp.</td>
      <td align="right" nowrap="nowrap"><?php echo number_format($data_inv_header->grand_total,2,",",".")  ?></td>
    </tr>
	<tr>
