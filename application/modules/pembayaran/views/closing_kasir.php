								...
								<div class="page-header-breadcrumb">
									<ul class=" breadcrumb breadcrumb-title">
										...
										<li class="breadcrumb-item"><a
												href="<?php echo base_url('Pembayaran/'); ?>">List Menu</a></li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="page-body">
									...
									<div class="container">
										<form class="form-horizontal"
											action="<?php echo site_url('pembayaran/closing_kasir_act'); ?>"
														...
														<table width="100%" border="1" cellpadding="4">
															...
															<tbody>
																...
																foreach ($data_inv as $k => $v) {
																	...
																	<tr>
																		...
																		<td align="right">
																			<?php echo number_format($v->subtotal, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->vcdisc_m, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->ppn, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->total_dp, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->total, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->total_noncash, 0, ",", ".") ?>
																		</td>
																		<?php foreach ($data_bank as $bank) {
																			$val_bank = 0;
																			...
																			?>
																			<td align="right">
																				<?php echo number_format($val_bank, 0, ",", ".") ?>
																			</td>
																		<?php } ?>
																		<td align="right">
																			<?php echo number_format($v->total_cash, 0, ",", ".") ?>
																		</td>
																	</tr>
																	<?php
															...
															<tfoot>
																<tr>
																	...
																	<td align="right">
																		<?php echo number_format($total_vcdisc_m, 0, ",", ".") ?>
																	</td>
																	<td align="right">
																		<?php echo number_format($total_ppn, 0, ",", ".") ?>
																	</td>
																	<td align="right">
																		<?php echo number_format($total_total_dp, 0, ",", ".") ?>
																	</td>
																	<td align="right">
																	...
																	<?php } ?>
																	<td align="right">
																		<?php echo number_format($total_total_cash, 0, ",", ".") ?>
																	</td>
																</tr>
															</tfoot>
														</table>
														...
														<table width="100%" border="1" cellpadding="4">
															...
															<tbody>
																...
																foreach ($data_inv_refund as $k => $v) {
																	...
																	<tr>
																		...
																		<td><?php echo $v->id_inv ?></td>
																		<td align="right">
																			<?php echo number_format($v->refund_total, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->refund_asuransi, 0, ",", ".") ?>
																		</td>
																		<td align="right">
																			<?php echo number_format($v->tunai, 0, ",", ".") ?>
																		</td>
																	</tr>
																	<?php
															...
															<tfoot>
																<tr>
																	<td align="right" colspan="5">Total : </td>
																	<td align="right">
																		<?php echo number_format($total_ref_total, 0, ",", ".") ?>
																	</td>
																	<td align="right">
																		<?php echo number_format($total_ref_asuransi, 0, ",", ".") ?>
																	</td>
																	<td align="right">
														...
														<table width="100%" border="1" cellpadding="4">
															<thead>
																<tr>
																	...
																	<?php foreach ($data_bank as $bank) { ?>
																		<th scope="col">Dp <?php echo $bank->nama_bank ?>
																		</th>
																	<?php } ?>
																...
																foreach ($data_dp as $k => $v) {
																	...
																	<tr>
																		...
																		<?php foreach ($data_bank as $bank) {
																			...
																			?>
																			<td align="right">
																				<?php echo number_format($val_dp_bank, 0, ",", ".") ?>
																			</td>
																		<?php } ?>
																		<td align="right">
																			<?php echo number_format($v->total_cash, 0, ",", ".") ?>
															...
															<tfoot>
																<tr>
																	<td align="right" colspan="5">Total : </td>
																	<td align="right">
																		<?php echo number_format($total_dp_total, 0, ",", ".") ?>
																	</td>
																	<?php foreach ($data_bank as $bank) { ?>
																		<td align="right">
																	...
																	<?php } ?>
																	<td align="right">
																		<?php echo number_format($total_dp_cash, 0, ",", ".") ?>
																	</td>
																</tr>
															</tfoot>
														</table>
														...
														<table width="100%" border="1" cellpadding="4">
															...
															<tbody>
																...
																foreach ($data_dp_refund as $k => $v) {
																	...
																	<tr>
																		...
																		<td><?php echo $v->id_trx ?></td>
																		<td align="right">
																			<?php echo number_format(($v->total * -1), 0, ",", ".") ?>
																		</td>
															...
															<tfoot>
																<tr>
																	<td align="right" colspan="5">Total : </td>
																	<td align="right">
																		<?php echo number_format($total_dp_ref_total, 0, ",", ".") ?>
																	</td>
																	<!--<td align="right"><?php #echo number_format($total_dp_cc1,0,",",".") ?></td>-->
																	<td align="right">
																		<?php echo number_format($total_dp_ref_cash, 0, ",", ".") ?>
																	</td>
																</tr>
															</tfoot>
														</table>
												...
												<div class="card">
													...
													<div class="card-block">
														...
														<div class="form-group row text-right">
															<label for="note_closing"
																class="col-sm-2 control-label">Note Closing : </label>
															<div class="col-sm-10">
																<textarea id="note_closing" name="note_closing"
														...
														<div class="form-group row text-right">
															<div class="col-sm-12">
																...
																<button type="button" class="btn btn-default"
																	onClick="javascript: location='<?php echo site_url('pembayaran'); ?>';">Kembali
																</button> &nbsp; &nbsp; &nbsp;
																<button type="submit"
