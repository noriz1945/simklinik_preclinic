...
<li class="breadcrumb-item">
<a href="<?php echo base_url('gdf/gdf_po_apv/'); ?>">Form BUAT PO</a>
</li>
</ul>
</div>
</div>
...
<button type="button" class="btn btn-success waves-effect waves-light" id="edit_apv">Simpan PO</button>
...
<script src=<?php echo base_url('assets/app_hn/stopopfnc/fncsto_purchase_order.js'); ?>></script>