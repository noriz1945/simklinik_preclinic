...
<input type="hidden" class="form-control input-default" id="id_reg" name="id_reg" value="<?php echo $id_reg; ?>">
     ...
     <table class="table table-bordered" style="width:100%">
      <thead>
        <tr class="headings">
          ...
          ?>
          <th class="column-title" colspan="1"><input type="text" id="rjdtanggal" name="tanggal" class="form-control" placeholder="Pilih Tanggal" onKeyDown="preventBackspace();" value="<?php echo $tanggal; ?>"></th>
          <th class="column-title" colspan="1"><select id="rjdjam" name="jam" class="form-control">
  ...
  <div class="col-sm-1">
  <button class="btn btn-success send_resikojatuh_1_rjd" type="button">Simpan <i class="fa fa-check"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Laporan : </label>
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_rjd" type="button">Harian<i class="fa fa-pdf"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Per Periode : </label>
  </div>
  <div class="col-sm-2">
  <input type="text" id="rjdtanggal_period_1" name="tanggal_period_1" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-2">
  <input type="text" id="rjdtanggal_period_2" name="tanggal_period_2" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_brjd" type="button"><i class="fa fa-search"></i></button>
  </div>
  </div>
  </div>
  ...
  <div class="table-responsive">
     <table class="table table-bordered" style="width:100%">                          
        <tbody id="tbriwrjd2" class="tbriwrjd3"></tbody>
    </table>
  </div>
</div>
...
$(document).ready(function(){
  loadingnyah();
  $('#rjdtanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjdtanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjdtanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
  
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#rjdtanggal').val();
  var jam_set     = $('#rjdjam').val();
  listmst(idreg_set,tanggal_set, jam_set);
});


$("#id_frmkepe_rjd").click(function(){
  loadingnyah();
  $('#rjdtanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjdtanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjdtanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
...
$("#rjdtanggal,#rjdjam").bind('change', function(){
  loadingnyah();
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#rjdtanggal').val();
  var jam_set     = $('#rjdjam').val();
...
function listmst(idreg_set,tanggal_set,jam_set){
  var pj = '<?php echo $creator; ?>';
    $.ajax({
      url : baseUrl+"formkeperawatan/frm_resikojatuh_dewasa/mst",
      method : "POST",
      ...
      success: function(data){
        ...
        var line_1_det='';
         ...
         +"</tr>"
         +"<tr>"
         +"<td colspan='5' style='vertical-align : middle;text-align:center;'><b>Tidak beresiko 0 - 24</b></td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='5' style='vertical-align : middle;text-align:center;'><b>Resiko Rendah 25 - 44</b></td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='5' style='vertical-align : middle;text-align:center;'><b>Resiko Tinggi > 45</b></td>"
         +"</tr>";
         $('#tbriwrjd').html(line_1_det+line_2_det);
        ...
        //Simpen
        $(".send_resikojatuh_1_rjd").click(function(e){
          e.preventDefault();
          var idreg_set     = $('#id_reg').val();
          var tanggal_set   = $('#rjdtanggal').val();
          var jam_set       = $('#rjdjam').val();
          ...
          $.ajax({
            url : baseUrl+"formkeperawatan/frm_resikojatuh_dewasa/save_news",
            method : "POST",
            ...
            success: function(data){
              ...
              Swal.fire('Berhasil!', 'RESIKO JATUH DEWASA', 'success');
            },
              error: function(xhr, ajaxOptions, thrownError) {
                show_my_error_message2(xhr.responseText,xhr.status,xhr.statusText);
              }
  ...
  function preventBackspace(e) {
    ...
    $("#report_rjd").click(function(){
      ...
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_resikojatuh_dewasa/mst_rep",
            method : "POST",
    ...
    $("#report_brjd").click(function(){
      var idreg_set              = $('#id_reg').val();
      var tanggal_period_1_set   = $('#rjdtanggal_period_1').val();
      var tanggal_period_2_set   = $('#rjdtanggal_period_2').val();
      //alert(idreg_set+"-"+tanggal_set);
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_resikojatuh_dewasa/mst_rep_periode",
            method : "POST",
