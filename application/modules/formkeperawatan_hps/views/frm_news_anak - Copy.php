...
<input type="hidden" class="form-control input-default" id="id_reg" name="id_reg" value="<?php echo $id_reg; ?>">
  ...
  <hr>
  <h5><b>NURSING EARLY WARNING SCORING SYSTEM (NEWS) ANAK</b></h5>
     ...
     <table class="table table-bordered" style="width:100%">
      <thead>
        <tr class="headings">
          ...
          ?>
          <th class="column-title" colspan="1"><input type="text" id="tanggal" name="tanggal" class="form-control" placeholder="Pilih Tanggal" onKeyDown="preventBackspace();" value="<?php echo $tanggal; ?>"></th>
          <th class="column-title" colspan="1"><select id="jam" name="jam" class="form-control">
  ...
  <div class="col-sm-1">
  <button class="btn btn-success send_news_1_a" type="button">Simpan <i class="fa fa-check"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Laporan : </label>
  </div>
  ...
  <div class="col-sm-2">
  <input type="text" id="tanggal_period_1" name="tanggal_period_1" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-2">
  <input type="text" id="tanggal_period_2" name="tanggal_period_2" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_b" type="button"><i class="fa fa-search"></i></button>
  </div>
  </div>
  </div>
  ...
  <div class="table-responsive">
     <table class="table table-bordered" style="width:100%">                          
        <tbody id="tbriwa2" class="tbriwa3"></tbody>
    </table>
  </div>
</div>
...
$(document).ready(function(){ 
  ...
  $('#tanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#tanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
...
$("#id_frmkepe_newsa").click(function(){
  loadingnyah();
  $('#tanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#tanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#tanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
...
$("#tanggal,#jam").bind('change', function(){
  loadingnyah();
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#tanggal').val();
  var jam_set     = $('#jam').val();
...
function listmst(idreg_set,tanggal_set,jam_set){
  var pj = '<?php echo $creator; ?>';
    $.ajax({
      url : baseUrl+"formkeperawatan/frm_news_anak/mst",
      method : "POST",
      ...
      success: function(data){
        ...
        var line_1_det='';
         ...
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>0 - 2 (Hijau)</b></td>"
         ...
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>3 - 4 (Kuning)</b></td>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'>Setiap 2 jam atau lebih cepat</td>"
         +"<td colspan='3' style='vertical-align : middle;text-align:center;'>Perawat jaga melakukan monitoring ulang, lapor DPJP dan atau dokter jaga ruangan</td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>5 atau > (Merah)</b></td>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'>30 Menit atau lebih cepat</td>"
         +"<td colspan='3' style='vertical-align : middle;text-align:center;'>Melapor ke dokter jaga ruangan dan DPJP, RJP, aktifkan Code Blue sistem, pindah ke ruangan observasi atau ICU</td>"
         +"</tr>";
         $('#tbriwa').html(line_1_det+line_2_det);
        ...
        //Simpen
        $(".send_news_1_a").click(function(e){
          e.preventDefault();
          loadingnyah();
          var idreg_set     = $('#id_reg').val();
          var tanggal_set   = $('#tanggal').val();
          ...
          $.ajax({
            url : baseUrl+"formkeperawatan/frm_news_anak/save_news",
            method : "POST",
            ...
            success: function(data){
              ...
              Swal.fire('Berhasil!', 'NEWSS ANAK', 'success');
            },
              error: function(xhr, ajaxOptions, thrownError) {
                show_my_error_message2(xhr.responseText,xhr.status,xhr.statusText);
              }
  ...
  function preventBackspace(e) {
    ...
    $("#report_a").click(function(){
      ...
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_news_anak/mst_rep",
            method : "POST",
         ...
         //for (irestind = 0; irestind < data.length; irestind++){ 
          ...
          //////////////////
              ...
              line_1_det +="<tr style='font-weight:bold;'><td colspan='2'>INDIKATOR</td><td>NILAI</td>"+t1td+t2td+t3td+t4td+t5td+t6td+t7td+t8td+t9td+t10td+t11td+t12td+t13td+t14td+t5td+t16td+t17td+t18td+t19td+t20td+t21td+t22td+t23td+t24td+"</tr>";
              /////////////////
            }
    ...
    $("#report_b").click(function(){
      ...
      var idreg_set              = $('#id_reg').val();
      var tanggal_period_1_set   = $('#tanggal_period_1').val();
      var tanggal_period_2_set   = $('#tanggal_period_2').val();
      //alert(idreg_set+"-"+tanggal_set);
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_news_anak/mst_rep_periode",
            method : "POST",
