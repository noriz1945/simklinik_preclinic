...
<tr class="clickable" data-toggle="collapse" id="<?php echo $v_2->id_reg; ?>" data-target=".<?php echo $v_2->id_reg; ?>collapsed">
<td><?php echo $no_1++; ?></td>
...
<?php if($v_2->is_bayar==0){ $isbayartxt='Invoice : Belum Bayar'; $isbayarlbl="label label-danger";}else{ $isbayartxt='Invoice :Sudah Bayar'; $isbayarlbl="label label-success";} ?>

<td><label class="<?php echo $isbayarlbl; ?>"><?php echo $isbayartxt; ?></label></td>
