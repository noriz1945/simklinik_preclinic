...
<li class="breadcrumb-item">
<a href="<?php echo base_url('gdf/gdf_kartu_stok/'); ?>">DAFTAR STOK BARANG</a>
</li>
</ul>
</div>
</div>
...
<div class="col-sm-2">
<input type="text" class="form-control" id="obatsearch" name="obatsearch" placeholder="Nama Barang">
...
<script src=<?php echo base_url('assets/app_hn/stopopfnc/fncsto_daftar_stok_barang.js'); ?>></script>