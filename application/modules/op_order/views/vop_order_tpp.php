    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          ...
          <th scope="col" class="text-center">Tanggal OP</th>
          <th scope="col" class="text-center">No. Registrasi</th>
          <!--<th scope="col" class="text-center">Poli</th>-->
          <th scope="col" class="text-center">Dokter DPJP</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <!--<td> xxx</td>-->
          <td> <?php echo $k['dpjp'];  ?></td>
          <td>
            <!--<a href="#" onclick="javascript:update_asm('<?php echo $k['id_pendaftaran']; ?>')"><img
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Form Order Operasi oleh tpp</h4>
      ...
      <div class="modal-body form_order_op">
        <form action="<?php echo base_url(). 'op_order/op_order/seve_order_op_tpp/'.$id_reg; ?>" method="post" id="form_order_op">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea class="form-control input-focus area-scroll" id="sewa_alat" name="sewa_alat" rows="5"
                  ...
                  <input type="text" name="id_prendaftaran_ai" id="id_prendaftaran_ai" class="form-control tanggal" value="<?php echo $date; ?>">
              </div>
            </div>
...
$(".delbutton").click(function(){
 ...
 $.ajax({
 type: "POST",
 url : '<?php echo site_url('op_order/op_order/delete_asm_tpp'); ?>/'+id_pend,
 data: info,
 success: function(){
