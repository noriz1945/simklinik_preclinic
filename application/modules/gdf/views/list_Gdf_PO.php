...
<title>REQUEST PEMBELIAN OBAT </title>
</head>
<body>
...
<div class="d-inline">
<h5>Request Pembelian Obat</h5>
<span>Request Pembelian</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item">
<a href="<?php echo base_url('gdf/gdf/'); ?>">Form Request Pembelian</a>
</li>
</ul>
</div>
</div>
...
<h5>List Request Pembelian Obat</h5>
</div>
...
<div class="col-sm-2">
<button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#large-Modal" id="createrpo"><i class="fa fa-plus"></i>Request Pembelian</button>
</div>
<div class="col-sm-2">
...
<h4 class="modal-title">BUAT REQUEST PEMBELIAN OBAT</h4>
...
<div class="col-sm-3">
<label>ID RPO</label>
<input type="text" class="form-control" id="no_rpo_p_set" name="no_rpo_p_set" readonly>
</div>
<div class="col-sm-3">
<label>Pabrik</label>
<input type="text" class="form-control" id="pabriksearch" name="pabriksearch" placeholder="Nama Pabrik">
<input type="text" class="form-control" id="id_pabrik" name="id_pabrik" readonly hidden>
</div>
<div class="col-sm-3">
<label>Tanggal</label>
<input type="text" class="form-control tanggalpo" id="tanggal_po" name="tanggal_po" placeholder="Tanggal">
</div>
</div>
...
<div class="col-sm-12" style="margin-top:5px; border:#CCC thin solid; padding:5px;">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <div class="ui-widget">
        <input type="text" id="qty_fts" name="qty_fts" class="form-control" readonly>
      </div>
    </div>
  </div>
  <div class="form-group row">
...
<div class="col-sm-3">
<label>Pabrik</label>
<input type="text" class="form-control row_3" id="edt_pabriksearch" name="edt_pabriksearch" placeholder="Nama Pabrik">
<input type="text" class="form-control row_4" id="edt_id_pabrik" name="edt_id_pabrik" readonly hidden>
</div>
<div class="col-sm-3">
<label>Tanggal</label>
<input type="text" class="form-control edt_tanggalpo row_5" id="edt_tanggal_po" name="edt_tanggal_po" placeholder="Tanggal">
</div>
</div>
...
<div class="col-sm-2">
<label>ID STO</label>
<input type="text" class="form-control row_0" id="endsto_no_rpo_p_set" name="endsto_no_rpo_p_set" readonly>
</div>
<div class="col-sm-5">
<label>PABRIK</label>
...
<script src=<?php echo base_url('assets/app_hn/stopopfnc/fncsto_gdf_po.js'); ?>></script>