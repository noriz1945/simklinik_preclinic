...
class Frm_neonatus extends MX_Controller {
	var $session_name='sp';
	...
	function __construct() {
		...
		$this->load->model('Mdl_neonatus','mdl');
	}
  ...
  public function frmasm($id_reg){
	...
	$this->load->view('frm_asm_neonatus', $data);
  }

  public function asm_neonatus_add($id_reg,$kategori){
		...
		//Neonatus 21 09 2023
		$neo_fld_1 						= $this->input->post('neo_fld_1');
		$neo_fld_2 						= $this->input->post('neo_fld_2');
		$neo_fld_3 						= $this->input->post('neo_fld_3');
		$neo_fld_4 						= $this->input->post('neo_fld_4');
		$neo_fld_5 						= $this->input->post('neo_fld_5');
		$neo_fld_6 						= $this->input->post('neo_fld_6');
		$neo_fld_7 						= $this->input->post('neo_fld_7');
		$neo_fld_8 						= $this->input->post('neo_fld_8');
		$neo_fld_9 						= $this->input->post('neo_fld_9');
		$neo_fld_10 					= $this->input->post('neo_fld_10');
		$neo_fld_11 					= $this->input->post('neo_fld_11');
		$neo_fld_12 					= $this->input->post('neo_fld_12');
		$neo_fld_13 					= $this->input->post('neo_fld_13');
		$chkneo_fld_14 					= $this->input->post('neo_fld_14');
		$neo_fld_14 					= implode(';',(array)$chkneo_fld_14);
		$neo_fld_14_b 					= $this->input->post('neo_fld_14_b');
		$neo_fld_15_a 					= $this->input->post('neo_fld_15_a');
		$neo_fld_15_b 					= $this->input->post('neo_fld_15_b');
		$neo_fld_15_c 					= $this->input->post('neo_fld_15_c');
		//$neo_fld_16 					= $this->input->post('neo_fld_16');
		//$neo_fld_17 					= $this->input->post('neo_fld_17');
		//End neonatus 21 09 2023
		...
		//neonatus item
		$mst_1						= $this->input->post('mst_1');
		$mst_2						= $this->input->post('mst_2');
		$mst_3						= $this->input->post('mst_3');
		$mst_4						= $this->input->post('mst_4');
		$mst_5						= $this->input->post('mst_5');
		$mst_6						= $this->input->post('mst_6');
		$chk_mst_7					= $this->input->post('mst_7'); $mna_7 = implode(';',(array)$chk_mst_7);
		$mst_8						= $this->input->post('mst_8');
		$mst_9						= $this->input->post('mst_9');
		$mst_10						= $this->input->post('mst_10');
		...
		$data_ott = array(
		  ...
		  'neo_fld_8'				=> $neo_fld_8,
		  'neo_fld_9'				=> $neo_fld_9,
		  'neo_fld_10'				=> $neo_fld_10,
		  'neo_fld_11'				=> $neo_fld_11,
		  'neo_fld_12'				=> $neo_fld_12,
		  'neo_fld_13'				=> $neo_fld_13,
		  'neo_fld_14'				=> $neo_fld_14,
		  'neo_fld_14_b'			=> $neo_fld_14_b,
		  'neo_fld_15_a'			=> $neo_fld_15_a,
		  'neo_fld_15_b'			=> $neo_fld_15_b,
		  'neo_fld_15_c'			=> $neo_fld_15_c,
	...
	public function asm_neonatus_edit_act($id_reg){
		$id_doc  = @$this->session->userdata['sp']->id_dokter;
    	if ($id_doc != NULL) {
    	  $id_dokter = $id_doc;
    	} else {
		...
		$mst_5						= $this->input->post('mst_5');
		$mst_6						= $this->input->post('mst_6');
		$chk_mst_7					= $this->input->post('mst_7'); $mst_7 = implode(';',(array)$chk_mst_7);
		$mst_8						= $this->input->post('mst_8');
		$mst_9						= $this->input->post('mst_9');
		$mst_10						= $this->input->post('mst_10');
		//$sudah_dibaca					= $this->input->post('sudah_dibaca');
	...
	public function asm_neonatus_edit($id_asmri){
