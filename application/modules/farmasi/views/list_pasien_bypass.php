                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover m-b-0">
                                                                            ...
                                                                            <tbody> <?php $no_1 =1;                                                                                     $arr_reg_aps = array('','APS');                                                                                    foreach($datapasien as $v_2){  ?> <tr class="clickable" data-toggle="collapse" id="
                                                                                    ...
                                                                                    <td> <?php echo $no_1++; ?> </td>
                                                                              <td><a href="<?php echo base_url('farmasi/print_eresep_bypass/'.$v_2->id_reg); ?>" target="_blank"><i class="fa fa-print"></i></a></td>      
                                                                              <td style="color:black;font-weight: 900;"><a href="<?php echo base_url('farmasi/rmbs/'.$v_2->id_reg); ?>"> <?php echo $v_2->id_reg; ?> </a></td>
                                                                                    ...
                                                                                    <td><?php echo number_format($v_2->total_tagihan, 0); ?></td>
                                                                                    ...
                                                                                    =============================== */
                                                                                    if ($v_2->id_inv == null) {
                                                                                        $isbayartxt = 'Invoice : Belum Bayar';
                                                                                        $isbayarlbl = 'label label-danger';
                                                                                    } else {
                                                                                        $isbayartxt = 'Invoice : Sudah Bayar';
                                                                                        $isbayarlbl = 'label label-success';
                                                                                    }
                                                                                    
                                                                                    /* ===============================
                                                                                       STATUS OBAT (LOGIKA FINAL)
                                                                                       1. total_tagihan = 0
                                                                                       2. id_resep di soap_eresep TIDAK ADA
                                                                                    =============================== */
                                                                                    if (
                                                                                        (int)$v_2->total_tagihan === 0 &&
                                                                                        ($v_2->id_resep == null || $v_2->id_resep == '')
                                                                                    ) {
                                                                                        $obattxt = 'Tidak Ada Obat';
                                                                                        $obatlbl = 'label label-warning';
                                                                                    } else {
                                                                                        $obattxt = 'Ada Obat';
                                                                                        $obatlbl = 'label label-info';
                                                                                    }
                                                                                    ?>
                                                                                    
                                                                                    <td>
                                                                                        <label class="<?php echo $isbayarlbl; ?>">
                                                                                            <?php echo $isbayartxt; ?>
                                                                                        </label>
                                                                                        <br>
                                                                                        <label class="<?php echo $obatlbl; ?>">
                                                                                            <?php echo $obattxt; ?>
                                                                                        </label>
                                                                                    </td>
