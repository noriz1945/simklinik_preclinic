    ...
    <div class="table-responsive">
      <table id="myTable" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr class="table-row" data-href="<?php echo site_url("erm_ranap/main_content/" . "$id_reg") ?>">
            <td>
              <?php echo $i; ?>
            </td>
            ...
            <td nowrap>
              <?php
                echo anchor(site_url("erm_ranap/main_content/" . "$id_reg"), "<img src=" . base_url('assets/img/tulis.png') . " style=\"max-height:20px;\">") . " &nbsp; ";
                ?>
            </td>
