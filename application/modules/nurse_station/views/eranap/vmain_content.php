  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url().'nurse_station/eranap'; ?>">
          ...
          <div class="tab-pane p-5" id="planning" role="tabpanel">
            <ul class="nav nav-tabs customtab2" role="tablist">
             ...
             <!-- <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#box_edukasi" role="tab" id="content_edukasi">
                  <span class="hidden-sm-up"><i class="ti-email"></i></span>
                  <span class="hidden-xs-down">Edukasi</span>
                </a>
              </li>

              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#box_dischargeplan" role="tab" id="id_dischargeplan">
                  <span class="hidden-sm-up"><i class="ti-email"></i></span>
                  <span class="hidden-xs-down">Perencanaan Pulang</span>
                </a>
              </li>

              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#box_transfer" role="tab" id="id_transfer">
                  <span class="hidden-sm-up"><i class="ti-email"></i></span>
                  <span class="hidden-xs-down">Transfer Pasien</span>
                </a>
              </li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane  p-20" id="box_edukasi" role="tabpanel">
                <div class="col-sm-12 text-center">
                <h5>Loading page content, please wait...</h5>
                <img src="<?php echo base_url('assets/img/loading-balls.gif'); ?>" alt="Loading Page">
                </div>
              ...
              <div class="tab-pane p-20" id="box_dischargeplan" role="tabpanel">
                <div class="col-sm-12 text-center">
                  <h5>Loading page content, please wait...</h5>
                  <img src="<?php echo base_url('assets/img/loading-balls.gif'); ?>" alt="Loading Page">
                </div>
              ...
              <div class="tab-pane p-20" id="box_transfer" role="tabpanel">
                <div class="col-sm-12 text-center">
                  <h5>Loading page content, please wait...</h5>
                  <img src="<?php echo base_url('assets/img/loading-balls.gif'); ?>" alt="Loading Page">
                </div>
...
$('#id_catatan_klinis').click(function(e) {
  inner_loader('<?php echo base_url('clinical_note/main_frame/'.$id_reg) ?>', '#box_catatan_klinis', true, '');
});
...
$('#content_edukasi').click(function(e) {
  inner_loader('<?php echo base_url('pemberian_edukasi/pemberian_edukasi/indexpemberianedukasi/'.$id_reg) ?>', '#box_edukasi', true, '');
});
...
$('#id_dischargeplan').click(function(e) {
  inner_loader('<?php echo base_url('ranap_discharge_planning/discharge_plan/indexdischargeplan/'.$id_reg) ?>', '#box_dischargeplan', true, '');
});

$('#id_transfer').click(function(e) {
  inner_loader('<?php echo base_url('transfer_pasien/transfer_pasien/transfer_pasien/'.$id_reg) ?>', '#box_transfer', true, '');
});
