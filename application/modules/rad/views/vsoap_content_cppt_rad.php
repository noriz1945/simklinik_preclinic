<div class="tab-pane active" id="plan3" role="tabpanel">
	<div class="p-5">
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<?php $segment4=$this->uri->segment('4'); $segment5=$this->uri->segment('5'); ?>
							<a href='#' class="btn btn-info add-new fa fa-plus" title='Tambah Sp-Radiologis'onclick='linkopen_add_rad();'>ADD</a>
							<script>
							function linkopen_add_rad() {
    						window.open("<?php echo site_url("rad/radiologi/indexrad/$segment4/$segment5"); ?>", "_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=100, left=100, width=1280, height=720px");
							}
							</script>
				...
				<table class="table table-bordered">
					...
					<?php
						...
						foreach($list_dat_pasien_rad as $k)
						{
...
<?php echo anchor_popup(("rad/radiologi/edit_formsprad/$segment4/$segment5/$k->id_digital_request"), "<label class='btn btn-info add-new fa fa-plus'>Edit</label>", '$attributes'); ?>

<?php echo anchor_popup(("rad/radiologi/delete_rad_id/$segment4/$segment5/$k->id_digital_request"), "<label class='btn btn-danger add-new fa fa-plus'>Delete</label>", '$attributes'); ?>
						</td>
							<?php
							$i++;
							}
