                                    ...
                                    <div class="col-lg-4">
                                        <div class="page-header-breadcrumb">
                                            <ul class=" breadcrumb breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item">
                                                    <a href="<?php echo base_url('farmasi/'); ?>">Penjualan obat bebas</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table table-hover m-b-0">
                                                                            ...
                                                                            <tbody> <?php $no_1 =1;                                                                                     $arr_reg_aps = array('','APS');                                                                                    foreach($datapasien as $v_2){  ?> <tr class="clickable" data-toggle="collapse" id="
                                                                                    ...
                                                                                    <td> <?php echo $no_1++; ?> </td>
                                                                                    <td> <?php echo $arr_reg_aps[$v_2->is_reg_aps]; ?> </td>
                                                                                    <td style="color:black;font-weight: 900;"> <?php                                                                                        if($v_2->is_reg_aps == 1)                                                                                         {                                                                                        ?> <a href="
																							<?php echo base_url('farmasi/aps/'.$v_2->id_reg); ?>"> <?php echo $v_2->id_reg; ?> </a> <?php                                                                                        }                                                                                        else                                                                                         {                                                                                        ?> <a href="
																							<?php echo base_url('farmasi/rm/'.$v_2->id_eresep); ?>"> <?php echo $v_2->id_reg; ?> </a> <?php                                                                                        }                                                                                         ?> </td>
