																					...
																					<div class="cardx border">
																						...
																						<div class="card-bodyx">
																							 <div class="form-group row text-right">
																								...
																								<div class="col-sm-3">
																									<input type="number" class="form-control text-right" id="total_noncash" name="total_noncash" value="0">
																								</div>
																							</div>
																						</div>
																					</div>
...
function hitung_ulang_ppn()
{
	...
	var ppn = parseInt(((parseInt(subtotal) - parseInt(vcdisc_m)) * 11)/100);
	$("#ppn").val(ppn);
	return ppn;
}
