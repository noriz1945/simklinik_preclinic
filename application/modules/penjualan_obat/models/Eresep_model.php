...
function mst_setting_harga(){
  ...
  function data_total_tagihan($id_eresep){
    ...
    $query=$this->db->query("SELECT SUM(subtotal) AS totalall FROM soap_eresep_det WHERE id_eresep='$id_eresep' AND status='0'");
  ...
  function validasi_obatnya($id_eresep,$subtotal_new,$tuslah,$jasa_racik,$set_depo){

    $query=$this->db->query("UPDATE soap_eresep_det SET tuslah='$tuslah', jasa_racik='0', is_validasi=1, set_depo='$set_depo',subtotal='$subtotal_new' WHERE id_eresep_det='$id_eresep'");
  ...
  function cancel_obatnya($id_eresep,$subtotal_new){
    ...
    $query=$this->db->query("UPDATE soap_eresep_det SET tuslah='0', jasa_racik='0', is_validasi=0, subtotal='$subtotal_new' WHERE id_eresep_det='$id_eresep'");
