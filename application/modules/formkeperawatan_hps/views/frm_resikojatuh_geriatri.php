...
<input type="hidden" class="form-control input-default" id="id_reg" name="id_reg" value="<?php echo $id_reg; ?>">
     ...
     <table class="table table-bordered" style="width:100%">
      <thead>
        <tr class="headings">
          ...
          ?>
          <th class="column-title" colspan="1"><input type="text" id="rjgtanggal" name="tanggal" class="form-control" placeholder="Pilih Tanggal" onKeyDown="preventBackspace();" value="<?php echo $tanggal; ?>"></th>
          <th class="column-title" colspan="1"><select id="rjgjam" name="jam" class="form-control">
  ...
  <div class="col-sm-1">
  <button class="btn btn-success send_resikojatuh_1_rjg" type="button">Simpan <i class="fa fa-check"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Laporan : </label>
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_rjg" type="button">Harian<i class="fa fa-pdf"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Per Periode : </label>
  </div>
  <div class="col-sm-2">
  <input type="text" id="rjgtanggal_period_1" name="tanggal_period_1" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-2">
  <input type="text" id="rjgtanggal_period_2" name="tanggal_period_2" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_brjg" type="button"><i class="fa fa-search"></i></button>
  </div>
  </div>
  </div>
  ...
  <div class="table-responsive">
     <table class="table table-bordered" style="width:100%">                          
        <tbody id="tbriwrjg2" class="tbriwrjg3"></tbody>
    </table>
  </div>
</div>
...
$(document).ready(function(){ 
  loadingnyah();
  $('#rjgtanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjgtanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjgtanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
  
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#rjgtanggal').val();
  var jam_set     = $('#rjgjam').val();
  listmst(idreg_set,tanggal_set, jam_set);
});


$("#id_frmkepe_rjg").click(function(){
  loadingnyah();
  $('#rjgtanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjgtanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#rjgtanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
...
$("#rjgtanggal,#rjgjam").bind('change', function(){
  loadingnyah();
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#rjgtanggal').val();
  var jam_set     = $('#rjgjam').val();
...
function listmst(idreg_set,tanggal_set,jam_set){
  var pj = '<?php echo $creator; ?>';
    $.ajax({
      url : baseUrl+"formkeperawatan/frm_resikojatuh_geriatri/mst",
      method : "POST",
      ...
      success: function(data){
        ...
        var line_1_det='';
         ...
         +"<td style='vertical-align : middle;text-align:center;' colspan='2'><input type='text' id='total_score_1arjg' name='total_score_1arjg' class='form-control' placeholder='Total Score' readonly></td>"
         +"</tr>"
         +"<tr>"
         ...
         +"</tr>"
         +"<tr>"
         +"<td colspan='5' style='vertical-align : middle;text-align:center;'><b>Tidak beresiko 0 - 5</b></td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='5' style='vertical-align : middle;text-align:center;'><b>Resiko Rendah 6 - 16</b></td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='5' style='vertical-align : middle;text-align:center;'><b>Resiko Tinggi 17 - 30</b></td>"
         +"</tr>";
         $('#tbriwrjg').html(line_1_det+line_2_det);
        ...
        $(".12jam_1a").each(function () {
          ...
          $("#total_score_1arjg").val(sum.toFixed(0));
          });
        });
        //end calc
        ...
        document.getElementById('total_score_1arjg').value = tot1;
        //end auto calc
        ...
        //Simpen
        $(".send_resikojatuh_1_rjg").click(function(e){
          e.preventDefault();
          var idreg_set     = $('#id_reg').val();
          var tanggal_set   = $('#rjgtanggal').val();
          var jam_set       = $('#rjgjam').val();
          ...
          $.ajax({
            url : baseUrl+"formkeperawatan/frm_resikojatuh_geriatri/save_news",
            method : "POST",
            ...
            success: function(data){
              ...
              Swal.fire('Berhasil!', 'RESIKO JATUH GERIATRI', 'success');
            },
              error: function(xhr, ajaxOptions, thrownError) {
                show_my_error_message2(xhr.responseText,xhr.status,xhr.statusText);
              }
  ...
  function preventBackspace(e) {
    ...
    $("#report_rjg").click(function(){
      ...
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_resikojatuh_geriatri/mst_rep",
            method : "POST",
         ...
         //for (irestind = 0; irestind < data.length; irestind++){ 
          ...
          line_1_det +="</td></tr>"
              ...
              +"<td colspan='24' style='vertical-align : middle;text-align:center;'><b>"+data[irestind].creator+"</b></td>"
              +"</tr><tr><td colspan='27' style='background-color:black;'></td></tr>";

              
         }

         $('#tbriwrjg2').html(line_1_det);
    ...
    $("#report_brjg").click(function(){
      var idreg_set              = $('#id_reg').val();
      var tanggal_period_1_set   = $('#rjgtanggal_period_1').val();
      var tanggal_period_2_set   = $('#rjgtanggal_period_2').val();
      //alert(idreg_set+"-"+tanggal_set);
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_resikojatuh_geriatri/mst_rep_periode",
            method : "POST",
