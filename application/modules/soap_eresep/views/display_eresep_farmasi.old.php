...
<div class="container-fluid">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="#" onClick="javascript: print_eresep('<?php echo $v['id_eresep']; ?>'); "><?php echo $v['nama_pasien']; ?></a></td>
      <td><?php echo $v['eresepdate']; ?></td>
      <td><?php echo $v['dokter']; ?></td>
      <td><?php echo 'non-racikan' ?></td>
    ...
    ?>
    <tr>
      <td colspan="6"><em>Data yang ditampilkan adalah data resep 6 jam sejak eResep dibuat oleh dokter. Setelah lewat 6 jam akan otomatis menghilang</em></td>
    </tr>
  </tbody>
</table>	
	</div>
