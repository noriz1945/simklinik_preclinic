                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                ...
                                <ul class="nav nav-tabs md-tabs " role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#tab_booking" id="id_booking" role="tab" aria-selected="false">
                                            <i class="icofont icofont-ui-user"></i>Check-In dari Bookingan</a>
                                        <div class="slide"></div>
                                    </li>
                                ...
                                <div class="tab-content card-block">
                                    <!-- START CONTENT TAB BOOKING TODAY -->
                                    <div class="tab-pane" id="tab_booking" role="tabpanel">
                                        <em>Silakan klik tab untuk memuat data booking hari ini.</em>
                                    </div>
                                    <!-- END CONTENT TAB BOOKING TODAY -->
...
<script>
$('#id_booking').on('click',function(e){
    $.ajax({
        url: '<?php echo site_url('trx_reg/inner_booking_today'); ?>',
        dataType: 'html',
