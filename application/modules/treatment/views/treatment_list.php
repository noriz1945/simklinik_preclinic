                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<form action="<?php echo base_url('treatment/treatment_update') ?>" method="post">
																...
																<tbody>
																	...
																	<tr class="tr_<?php echo $no; ?>">
																		...
																		<td nowrap align="center"> 
																			<input type="hidden" id="id_trx[<?php echo $no ?>]" name="id_trx[]" value="<?php echo $v->id_trx ?>" />
																			<input type="checkbox" id="chk_id_trx[<?php echo $no ?>]" name="chk_id_trx[<?php echo $v->id_trx ?>]" value="<?php echo $v->id_trx ?>" <?php echo $v->checked_treatment ?> onClick="javascript: return update_treatment('<?php echo $v->id_trx ?>','<?php echo $v->grup ?>');" />
