															...
															<div class="card-header">
																...
																<div class="card-block">
																	...
																	<div class="jumbotron jumbotron-fluid">
																	  <div class="container">
																		<h1 class="display-4">Closing Kasir</h1>
																		<p class="lead">Sepertinya status kasir kamu belum terbuka.</p>
																	  </div>
																	</div>
																	...
																	<div class="form-group row">
																		...
																		<div class="col-sm-6 text-right">
																			<button type="button" class="btn btn-primary" onClick="javascript: location='<?php echo site_url('pembayaran/opening_kasir'); ?>';">Opening Kasir </button>
																		</div>
																	</div>
