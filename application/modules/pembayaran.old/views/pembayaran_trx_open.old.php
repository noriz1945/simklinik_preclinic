																				...
																				<div class="card-block">
																					...
																					<div class="form-group row text-right">
																						...
																						<div class="col-sm-2" style="padding-right:0;">
																							<input type="text" class="form-control text-right" id="disc_persen" name="disc_persen" value="0" style="width:65px;" maxlength="5">
																						</div>
...
$("#disc_persen").on("keyup", function(evt) {
	...
	var yg_harus_dibayar = parseInt(subtotal) - parseInt(total_dp);
	var diskon_rp = (yg_harus_dibayar * persentase )/100;
...
$("#vcdisc_m").on( "input", function() {
	...
	var diskon_persen = parseInt(vcdisc_m)*100 / (parseInt(subtotal)-parseInt(total_dp));
	diskon_persen = parseFloat(diskon_persen).toFixed(2);
