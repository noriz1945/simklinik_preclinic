...
<!-- Start Page Content -->
	<div class="row">
		...
		<div class="card-body">
	   <form id="frm_order_lab" action="<?php echo base_url(). 'lab/splab/tambah_aksi/'.$optional_page; ?>" method="post">
...
<!--2-->
 ...
 <?php   if($dh_33->checkbox==1){
    ...
    <h6 style="color:black" <?php echo $hiddena; ?>><?php $no++; echo $no; ?>. <input type="<?php echo $chkortxt; ?>" class="<?php echo $classvar; ?>" <?php echo $hiddena; ?> name="tindakan[<?php echo $dh_33->id_item ?>]" value="<?php echo $dh_33->name_item ?>"> <?php echo $dh_33->name_item; ?></h6>
 <!--/span-->
 <?php } ?>
    <div class="input-group-addon">
    <span class="glyphicon glyphicon-th"></span>
...
if(optional_page!='')
{
	$('#frm_order_lab').submit(function(event) {
