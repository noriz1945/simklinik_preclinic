...
$("#id_frmkepe_kpkpicu").click(function(){
  var idreg_set = $('#id_reg').val();
  listmst(idreg_set);
});
...
function listmst(idreg_set){
  var pj = '<?php echo $creator; ?>';
    $.ajax({
      url : baseUrl+"formkeperawatan/frm_kpk_picu/mst",
      method : "POST",
      ...
      success: function(data){
        ...
        $(".send_news_1_akpk").click(function(e){
          ...
          $.ajax({
            url : baseUrl+"formkeperawatan/frm_kpk_picu/save_news",
            method : "POST",
    ...
    $("#report_a").click(function(){
      var idreg_set     = $('#id_reg').val();
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_kpk_picu/mst_rep",
            method : "POST",
            data : { idreg_set:idreg_set},
            //async : false,
            dataType : 'json',
        ...
        let sumnailainya_1 = 0;
          ...
          line_1_det +="</td></tr>"
              ...
              $('.tbriwa3kpkpicu').html(line_1_det2+line_1_det);
