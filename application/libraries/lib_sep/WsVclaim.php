<?php
/*--------------------------------------------------*/
// Created by luthfi.mawardi@gmail.com 		[29-01-2018]
// update Version 1.0 to 1.1 By Sarkodan	[01-10-2018]
// Porting to CodeIgniter    By Sarkodan	[19-10-2018]
/*--------------------------------------------------*/
...
class WsVclaim {
  ...
  function get_signature($cons_id,$secretKey)
	...
	# Format : Json
	# Content-Type: application/json; charset=utf-8
	public function sep_update(	$noSep,$klsRawat,$noMR,$asalRujukan,$tglRujukan,
															$noRujukan,$ppkRujukan,$catatan,$diagAwal,$eksekutif,
															$cob,$lakaLantas,$penjamin,$lokasilaka,$noTelp,$user )
	{		
		$method = 'PUT';
