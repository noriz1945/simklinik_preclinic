...
<div class="row">
  <div class="col-sm-6" style="padding:1px;">
    <div class="card">
      ...
      <div class="card-body" style="border:black thin solid; min-height:700px; padding:5px;">





        <h5 class="p-20 z-depth-0" style="margin:5px 0 0 0; padding:5px;background:#00ced1;color:white;">Item resep baru : </h5>
        <div class="table-responsive" style=" border:#CCC thin solid; max-width:900px;">
          <form id="frm_draft" method="post" action="<?php echo base_url('soap_eresep/save_eresep'); ?>">
            ...
            <h6 class="p-20 z-depth-0">Obat Non-Racikan</h6>
            ...
            <h6 class="p-20 z-depth-0">Obat Racikan</h6>
            <table class="table table-bordered table-hover table-striped table-responsive styled-table">
              <thead>
                <tr>
                </tr>
        ...
        <h5 class="p-20 z-depth-0" style="margin:5px 0 0 0; padding:5px;background:#00ced1;color:white;">Input Obat Non-Racikan : </h5>
        <div class="col-sm-12" style="margin-top:5px; border:#CCC thin solid; padding:5px;">
          ...
          <form>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input id="qtyset" name="qtyset" class="form-control">
              </div>
            </div>
        ...
        <!-- The Modal add racikan : input biasa -->
        <!--MODAL SEGMENT 4-->
...
<!--END MODAL SEGMENT 4-->
  ...
  <div class="col-sm-6">
    <div class="card">
      ...
      <div class="card-body" id="box-riwayat-resep-online" style="border:black thin solid; min-height:700px;">
...
$('#addrow').click(function(e) {
  ...
  var id_obat = id_fa;
  $.ajax({
      url : baseUrl+"soap_eresep/soap_eresep/prosesdetailobat",
      method : "POST",
    ...
    '<td>' + note + '				<input type="hidden" name="note[]" 				value="' + note + '"></td> \n ' +
        ...
        '<td>' + formatMoney(total_harga_obat,0) + ' <input type="hidden" name="subtotal[]" value="' + total_harga_obat + '"></td> \n ' +
...
/*$('#frm_draft').submit(function(event) {
  ...
  //$("#box-riwayat-resep-online").load( "<?php echo base_url('soap_eresep/list_riwayat_resep_online/'); ?>" + <?php echo $id_reg ?> );
});*/

$('#butt_simpan_resep').click(function(event) {
  event.preventDefault(); //prevent default action 
  /////
Swal.fire({
   title: 'Simpan',
   ...
   if (result.isConfirmed) {
         swal.fire('Simpan!','Simpan Resep berhasil!', 'success').then(function(){ 
          $('#butt_simpan_resep').attr('disabled', 'disabled');
          setTimeout(function() {
            $('#butt_simpan_resep').removeAttr('disabled');
          }, 30000);
        
          var form_data = $('#frm_draft').serialize(); //Encode form elements for submission
          var id_reg = $('#id_reg').val();
          var id_pasien = $('#id_pasien').val();
          $.ajax({
              url : baseUrl+"soap_eresep/save_eresep",
              method : "POST",
              data : form_data,
              async : true,
              dataType : 'html',
       ...
       Swal.fire('Batal Simpan!', 'Batal Simpan Resep!', 'info')
     }
})
////
});
    ...
    if (result.isConfirmed) {
      ...
      success: function(datarestind){
        $('#box_new_eresep').html(datarestind);
          ...
          swal.fire('Batal!','Batal Resep Berhasil!', 'success').then(function(){ 
        ...
        Swal.fire('Batal Resep!', 'Tidak jadi batal resep!', 'info')
      }
 })
 ////
