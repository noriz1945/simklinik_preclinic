<div class="container-fluid form_news_dewasa">
<input type="hidden" class="form-control input-default" id="id_reg" name="id_reg" value="<?php echo $id_reg; ?>">

  <hr>
  <h5><b>NURSING EARLY WARNING SCORING SYSTEM (NEWS) DEWASA</b></h5>
     ...
     <table class="table table-bordered" style="width:100%">
      <thead>
        <tr class="headings">
          ...
          ?>
          <th class="column-title" colspan="1"><input type="text" id="dtanggal" name="tanggal" class="form-control" placeholder="Pilih Tanggal" onKeyDown="preventBackspace();" value="<?php echo $tanggal; ?>"></th>
          <th class="column-title" colspan="1"><select id="djam" name="jam" class="form-control">
  ...
  <div class="col-sm-1">
  <button class="btn btn-success send_news_1_d" type="button">Simpan <i class="fa fa-check"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Laporan : </label>
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_d" type="button">Harian<i class="fa fa-pdf"></i></button>
  </div>
  <div class="col-sm-1">
  <label>Per Periode : </label>
  </div>
  <div class="col-sm-2">
  <input type="text" id="dtanggal_period_1" name="tanggal_period_1" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-2">
  <input type="text" id="dtanggal_period_2" name="tanggal_period_2" class="form-control" placeholder="Pilih Tanggal" value="<?php echo $tanggal; ?>">
  </div>
  <div class="col-sm-1">
  <button class="btn btn-warning" id="report_db" type="button"><i class="fa fa-search"></i></button>
  </div>
  </div>
  </div>
  ...
  <div class="table-responsive">
     <table class="table table-bordered" style="width:100%">                          
        <tbody id="tbriwd2" class="tbriwd3"></tbody>
    </table>
  </div>
</div>
...
$(document).ready(function(){
  loadingnyah();
  $('#dtanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#dtanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#dtanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
  
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#dtanggal').val();
  var jam_set     = $('#djam').val();
  listmst(idreg_set,tanggal_set,jam_set);
});


$("#id_frmkepe_newsd").click(function(){
  loadingnyah();
  $('#dtanggal').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#dtanggal_period_1').datepicker({ dateFormat: 'dd-mm-yy' });
  $('#dtanggal_period_2').datepicker({ dateFormat: 'dd-mm-yy' });
...
$("#dtanggal").change(function(){
  loadingnyah();
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#dtanggal').val();
  var jam_set     = $('#djam').val();
  listmst(idreg_set,tanggal_set,jam_set);
  //$(".12jam_1").prop('disabled', false);
  //$(".12jam_2").prop('disabled', false);
});

$("#dtanggal,#djam").bind('change', function(){
  loadingnyah();
  var idreg_set   = $('#id_reg').val();
  var tanggal_set = $('#dtanggal').val();
  var jam_set     = $('#djam').val();
...
function listmst(idreg_set,tanggal_set,jam_set){
  var pj = '<?php echo $creator; ?>';
    $.ajax({
      url : baseUrl+"formkeperawatan/frm_news_dewasa/mst",
      method : "POST",
      ...
      success: function(data){
        ...
        var line_1_det='';
         for (irestind = 0; irestind < data.length; irestind++){ 
          ...
          for (irestind2 = 0; irestind2 < data[irestind].rs_1.length; irestind2++){
            ...
            +"<td  colspan='2'><input type='text' id='12jam_1d[]' name='12jam_1d[]' class='form-control 12jam_1d' placeholder='Isi Nilai' attr-data-idmst='"+data[irestind].rs_1[irestind2].id+"' value='"+nilai_1_set+"'></td>"
            +"</tr>";
          }
          line_1_det +="</td></tr>";
         }
         ...
         +"<td style='vertical-align : middle;text-align:center;' colspan='2'><input type='text' id='total_score_1d' name='total_score_1d' class='form-control' placeholder='Total Score' readonly></td>"
         +"</tr>"
         +"<tr>"
         ...
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>0-1 ( Hijau)</b></td>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'>observasi / 12 jam</td>"
         +"<td colspan='3' style='vertical-align : middle;text-align:center;'>Kondisi pasien stabil dan observasi per shif </td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>2 s.d 3 (Kuning)</b></td>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'>observasi 4 s.d. 6 jam</td>"
         +"<td colspan='3' style='vertical-align : middle;text-align:center;'>Lapor PJT untuk peningkatan frekuensi observasi</td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>4 - 5 (Oranye)</b></td>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'>observasi / jam</td>"
         +"<td colspan='3' style='vertical-align : middle;text-align:center;'>lapor dokter jaga dan Pindah ruang observasi</td>"
         +"</tr>"
         +"<tr>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'><b>> 6 (merah)</b></td>"
         +"<td colspan='1' style='vertical-align : middle;text-align:center;'>observasi kontinyu</td>"
         +"<td colspan='3' style='vertical-align : middle;text-align:center;'>Lapor dokter jaga ruangan dan DPJP aktifkan code blue system , pindah ICU / tetap di ruangan</td>"
         +"</tr>";
         $('#tbriwd').html(line_1_det+line_2_det);



         $('.12jam_1d').on('input blur paste', function(){
          $(this).val($(this).val().replace(/\D/g, ''));
         });

        //calc
        $(".12jam_1d").each(function () {
          ...
          $("#total_score_1d").val(sum.toFixed(0));
          });
        });
        //end calc
        ...
        //auto calc
        var arr1 = document.getElementsByClassName('12jam_1d');
        var tot1=0;
        for(var i1=0;i1<arr1.length;i1++){
          if(parseFloat(arr1[i1].value))
            tot1 += parseFloat(arr1[i1].value);
        }
        document.getElementById('total_score_1d').value = tot1;
        //end auto calc
        ...
        //Simpen
        $(".send_news_1_d").click(function(e){
          e.preventDefault();
          var idreg_set     = $('#id_reg').val();
          var tanggal_set   = $('#dtanggal').val();
          var jam_set       = $('#djam').val();
          ...
          $('input[name="12jam_1d[]"]:input').each(function(){ 
          ...
          $.ajax({
            url : baseUrl+"formkeperawatan/frm_news_dewasa/save_news",
            method : "POST",
            ...
            success: function(data){
              ...
              Swal.fire('Berhasil!', 'NEWSS DEWASA', 'success');
              return false;
  ...
  function preventBackspace(e) {
    ...
    $("#report_d").click(function(){
      loadingnyah();


      var idreg_set     = $('#id_reg').val();
      var tanggal_set   = $('#tanggal').val();
      //alert(idreg_set+"-"+tanggal_set);
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_news_dewasa/mst_rep",
            method : "POST",
    ...
    $("#report_db").click(function(){
      loadingnyah();
      var idreg_set              = $('#id_reg').val();
      var tanggal_period_1_set   = $('#dtanggal_period_1').val();
      var tanggal_period_2_set   = $('#dtanggal_period_2').val();
      //alert(idreg_set+"-"+tanggal_set);
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_news_dewasa/mst_rep_periode",
            method : "POST",
