...
<h2 class="bg-primary text-center" style="border-radius:5px;">Buat / Edit Sub Menu</h2>
<form class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">  
  ...
  <div class="form-group">
	...
	<!-- DROPDOWN -->
  <div class="form-group">
    <label for="id_menu" class="col-sm-4 control-label">Id Menu</label>
    <div class="col-sm-8">
      {dropdown-id_menu}
    </div>
  </div>
	...
	<!-- NUMERIC -->
  <div class="form-group">
    <label for="no_urut" class="col-sm-4 control-label">No Urut</label>
    <div class="col-sm-8">
			<input type="number" class="form-control" name="no_urut" id="no_urut" placeholder="No Urut" value="<?php echo $no_urut; ?>" />
    </div>
  </div>
	
	<!-- TEXT -->
  <div class="form-group">
    <label for="submenu" class="col-sm-4 control-label">Submenu</label>
    <div class="col-sm-8">
  ...
  <div class="form-group">
  	<div class="col-sm-4 col-sm-offset-4">
			...
			<input type="hidden" name="id_submenu" value="<?php echo $id_submenu; ?>" />
			
      <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
      <button type="submit" class="btn btn-primary">Simpan</button>

      <button type="button" class="btn btn-default" onClick="javascript: location='<?php echo site_url('mst_nav_submenu'); ?>';">Kembali</button>
