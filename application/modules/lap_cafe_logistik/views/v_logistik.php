                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title"><i class="feather icon-book bg-c-blue"></i>
                                        <div class="d-inline">
                                            <h5>Laporan</h5><span>Laporan Logistik Berdasarkan Periode</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('lap_cafe_logistik/logistik'); ?>">Lap. Logistik (Periodik)</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
																...
																<div class="card-block">
																	<div class="row">
																		...
																		<div class="col-md-11">
																			...
																			<form class="form-inline" action="<?php echo site_url('lap_cafe_logistik/logistik'); ?>" method="post">
