...
<div class="d-inline">
<h5>BATAL CLOSING PO</h5>
<span>BATAL CLOSING PO</span>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item">
<a href="<?php echo base_url('gdf/Gdf_purchase_order_closing/'); ?>">Form batal closing po </a>
</li>
</ul>
</div>
</div>
...
<div class="col-sm-3">
<input type="text" id="startdate_set" name="startdate_set" class="form-control" placeholder="Pilih Tanggal Mulai">
</div>
<div class="col-sm-3">
<input type="text" id="enddate_set" name="enddate_set" class="form-control" placeholder="Pilih Tanggal Akhir">
</div>
<div class="col-sm-2">
...
<button type="button" class="btn btn-warning waves-effect waves-light" id="edit_apv">Open PO</button>
...
<script src=<?php echo base_url('assets/app_hn/stopopfnc/fncsto_purchase_order_batal_closing.js'); ?>></script>