                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title"><i class="feather icon-book bg-c-blue"></i>
                                        <div class="d-inline">
                                            <h5>Form Pembuatan Pembagian Jasa Medis</h5><span>Menu</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="
											<?php echo base_url('Trx_jasmed/'); ?>">List Menu</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <div class="page-body">
										<form id="frm_jasmed" class="" action="<?php echo base_url('v_jasmed/save') ?>" method="post" enctype="multipart/form-data">
											<div class="row">
												<div class="col-sm-6">		
												
													<div class="card" style="min-height:370px;padding: 0 20px;">
														<div class="card-header">
															<h4>Pilih Nakes & Periode Tindakan</h4>
														</div>
														<div class="card-block">
															...
															<div class="form-group row">
																<label for="id_nakes" class="col-sm-3 control-label">Tenaga Kesehatan</label>
																<div class="col-sm-6">
															...
															<div class="form-group row">
																<div class="col-sm-4">
																	<button type="button" class="btn btn-default" onClick="javascript: location='<?php echo site_url('v_jasmed'); ?>';">Kembali </button>
																</div>
																<div class="col-sm-4 text-right">
																	<button id="tampilkan" type="button" class="btn btn-success">Tampilkan pembagian jasa medis</button>
																</div>
															</div>
												...
												<div class="col-sm-6">		
													...
													<div class="card d-none" id="box_rekap_share" style="min-height:370px;padding: 0 20px;">
														<div class="card-header">
															<h4>Rekap Pembagian Jasa Medis</h4>
														</div>
														<div class="card-block">
															<h4 class="sub-title"></h4>
															<div class="form-group row">
																<label for="r_id_nakes" class="col-sm-4 col-form-label">Id. Nakes</label>
																<div class="col-sm-8">
																  <input type="text" class="form-control" id="r_id_nakes" name="r_id_nakes" readonly >
																</div>
															</div>
															<div class="form-group row">
																<label for="r_nama_nakes" class="col-sm-4 col-form-label">Nama Nakes</label>
																<div class="col-sm-8">
																  <input type="text" class="form-control" id="r_nama_nakes" name="r_nama_nakes" readonly >
																</div>
															</div>
															<div class="form-group row">
															...
															<div class="form-group row">
																<div class="col-sm-4">
																	<button type="button" class="btn btn-default" onClick="javascript: location='<?php echo site_url('v_jasmed/add'); ?>';">Ulangi </button>
																</div>
																<div class="col-sm-4 text-right">
...
<script>
$('select[name="id_nakes"]').attr("required","required");
...
<script>
//$('#frm_jasmed').on('submit', function(e){
//	e.preventDefault();
$('#tampilkan').on('click', function(e){
	$.ajax({
		url: '<?php echo site_url('v_jasmed/add_detail'); ?>',
		type : 'POST',
		...
		success: function(html) {
			...
			var val_id_nakes = $('#id_nakes').find(":selected").val();
			$('#r_id_nakes').val(val_id_nakes);
			
			var text_id_nakes = $('#id_nakes').find(":selected").text();
			$('#r_nama_nakes').val(text_id_nakes);
			...
			var total = $('#table_total_share_nakes').val();
			$('#r_total').val(total);
...
$("#simpan").on("click", function() {
	$.ajax({
		url		: '<?php echo site_url('v_jasmed/save'); ?>',
		type 	: 'POST',
		data 	: $('#frm_jasmed').serialize(),
		success	: function(html) {}
	});
...
*/
$("#simpan").on("click", function() {
	$('#frm_jasmed').attr('action', '<?php echo base_url('v_jasmed/save') ?>');
	$('#frm_jasmed').submit();
});
</script>
