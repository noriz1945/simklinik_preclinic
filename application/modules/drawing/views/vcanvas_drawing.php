...
<!--    <body onload="init()">	-->
  <div class="row">
    ...
    <div class="col-md-5">
      ...
      <img id="canvasimg" width="350px" height="350px" style="top:10%;left:10%;border:2px solid;display:none;">
    </div>
  </div>
  ...
  <div class="col-md-12" style="padding-top: 15px;">
    <div class="row">
      <div class="col-md-2">
        <button type="button" class="btn btn-info" onclick="javascript: save();"> <i class="fa fa-eye"></i> PREVIEW</button>
      </div>
      <div class="col-md-2">
        <button type="button" class="btn btn-warning" onclick="javascript: erase();"> <i class="fa fa-eraser"></i> CLEAR</button>
      </div>
      <div class="col-md-2">
        <input type="hidden" class="form-control input-default urlblob" id="urlblob" name="urlblob" value="">
        <button type="button" class="btn btn-success" onclick="javascript: save_drawing('<?php echo $id_reg ?>');"> <i class="fa fa-check"></i> SIMPAN</button>
      </div>
    </div>
...
<script>
  ...
  function save_drawing(id_reg) {
    var url;
    save_method = 'add';

    if (save_method == 'add') {
      url = '<?php echo site_url('drawing/save_drawing'); ?>/'+id_reg;
