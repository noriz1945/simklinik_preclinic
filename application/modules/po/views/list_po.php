...
<?php require_once(APPPATH.'../assets/app_hn/pofnc/mnu-cmp-css.php');?>
...
<form action="<?php echo base_url('po/po/save/'); ?>" method="POST" id="form">
...
<?php require_once(APPPATH.'../assets/app_hn/pofnc/mnu-cmp-js.php');?>
<script src=<?php echo base_url('assets/app_hn/pofnc/fncpo.js'); ?>></script>