						<form class="form-horizontal setsimpanpasienlama" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6">
													...
													<!-- BUTTON -->
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <button type="button" class="btn btn-success simpanpasienlama">Simpan</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
	$(".simpanpasienlama").click(function(e) {
		e.preventDefault(); // avoid to execute the actual submit of the form.
		var form = $('.setsimpanpasienlama');
		...
		$.ajax({
			type: "POST",
			url : baseUrl+"trx_reg_book/trx_reg/create_action",
