...
function listmst(idreg_set){
  var pj = '<?php echo $creator; ?>';
    $.ajax({
      url : baseUrl+"formkeperawatan/frm_kpk_icu/mst",
      method : "POST",
      ...
      success: function(data){
        ...
        $(".send_news_1_akpk").click(function(e){
          ...
          $.ajax({
            url : baseUrl+"formkeperawatan/frm_kpk_icu/save_news",
            method : "POST",
            ...
            success: function(data){
              ...
              Swal.fire('Berhasil!', 'Formulir Kriteria Pasien Keluar ICU', 'success');
            },
              error: function(xhr, ajaxOptions, thrownError) {
                show_my_error_message2(xhr.responseText,xhr.status,xhr.statusText);
              }
    ...
    $("#report_a").click(function(){
      var idreg_set     = $('#id_reg').val();
      $.ajax({
            url : baseUrl+"formkeperawatan/frm_kpk_icu/mst_rep",
            method : "POST",
            data : { idreg_set:idreg_set},
            //async : false,
            dataType : 'json',
        ...
        let sumnailainya_1 = 0;
          ...
          line_1_det +="</td></tr>"
              ...
              $('.tbriwa3kpk').html(line_1_det2+line_1_det);
