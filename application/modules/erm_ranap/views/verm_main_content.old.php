  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#box_tool_keperawatan" role="tab" id="id_tool_keperawatan">
            <span class="hidden-sm-up"><i class="ti-email"></i></span>
      ...
      <div class="tab-content">
          ...
          <div class="tab-pane p-5" id="box_tool_keperawatan" role="tabpanel">
...
$('#id_asm_awal_ranap').click(function(e) {
  inner_loader('<?php echo base_url('erm_ranap/asm_ranap/'.$id_reg) ?>', '#box_asm_awal_ranap', true, '');
});
