...
<form action="<?php echo base_url(). 'fisio/rehabmedik/tambah_aksi'; ?>" method="post">
<!-- Container fluid  -->
                ...
                <div class="col-lg-6">
                        <div class="card card-outline-success">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Form SP REHAB MEDIK</h4>
                            </div>
                            <div class="card-body">
                                <form action="#">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="diag" class="form-control" placeholder="Diagnosa">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Terapi</label>
                                                    <input type="text" name="terapi" class="form-control" placeholder="Terapi">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Belum dapat dikembalikan ke fasilitas perujuk dengan alasan</label>
                                                    <input type="text" name="poin1" class="form-control" placeholder="Alasan">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Rencana tindak lanjut yang akan dilakukan pada kunjungan selanjutnya</label>
                                                    <input type="text" name="poin2" class="form-control" placeholder="Rencana">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
