                                                            ...
                                                            <div class="col-md-6 offset-md-3 card z-depth-5">
                                                                ...
                                                                <form class="form-horizontal">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<p class="form-control-static"><?php echo $nama_promo; ?></p>
																		</div>
																	</div>
																	<!-- RADIO -->
																	<fieldset disabled>
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<p class="form-control-static"><?php echo $start; ?></p>
																		</div>
																	</div>
																	<!-- STATIC CONTROL -->
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<p class="form-control-static"><?php echo $end; ?></p>
																		</div>
																	</div>
																	<!-- STATIC CONTROL -->
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<p class="form-control-static"><?php echo $quota; ?></p>
																		</div>
																	</div>
																	<!-- STATIC CONTROL -->
																	<div class="form-group">
