                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title"><i class="feather icon-book bg-c-blue"></i>
                                        <div class="d-inline">
                                            <h5>Laporan</h5><span>Laporan Tindakan berdasarkan periode</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('keuangan/tindakan_list'); ?>">Lap. Tindakan (Periodik)</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
																...
																<div class="card-block">
																	<div class="row">
																		...
																		<div class="col-md-11">
																			...
																			<form class="form-inline" action="<?php echo site_url('keuangan/tindakan_list'); ?>" method="post">
																				...
																				<div class="form-group mx-sm-3 mb-2">
																					<label for="periode_end" class="sr-only">Tindakan</label>
																					<?php echo $dropdown_id_act ?>
																				</div>
																		...
																		<table id="inv_table" class="table table-bordered table-hover table-striped">
																			...
																			<!-- <thead> --> 
																				<tr>
																					...
																					<th scope="col">Harga<br>Satuan(Rp)</th>
																					<th scope="col">Disc Satuan(Rp)</th>
																					<th scope="col">Qty</th>
																					
																					<th scope="col">Harga(Rp)</th>
																					<th scope="col">Asuransi</th>
																					<th scope="col">Status<br>Inv</th>
																				</tr>
																			</thead>
																			<tbody>
																				<?php
																				...
																				<tr>
																					<td><?php echo $i ?></td>
																					<!--<td><?php echo $data->tgl_tindakan ?></td>-->
																					
																					
																					<td><?php echo $data->id_reg ?></td>
																					<td><?php echo $data->id_pasien ?></td>
																					<!--<td><?php #echo $data->is_reg_aps ?></td>-->
																					<td><?php echo $data->pasien ?></td>
																					<!--<td><?php #echo $data->id_asuransi ?></td>-->
																					
																					<!--<td><?php #echo $data->id_dokter_prt1 ?></td>-->
																					<td><?php echo $data->nakes ?></td>
																					<td><?php echo $data->name ?></td>
																					<td><?php echo number_format($data->tarif_satuan,0,",",".") ?></td>
																					<td><?php echo number_format($data->disc,0,",",".") ?></td>
																					<td><?php echo $data->qty ?></td>
																					
																					<td><?php echo number_format($data->tarif,0,",",".") ?></td>
																					<td><?php echo $data->asuransi ?></td>
																					<td><?php echo $data->inv_status ?></td>
																					<!--
																					<td><?php echo number_format($data->subtotal,0,",",".") ?></td>
																					<td><?php echo number_format($data->total_dp,0,",",".") ?></td>
																					<td><?php echo number_format($data->vcdisc_m,0,",",".") ?></td>
																					<td><?php echo number_format($data->total_inv,0,",",".") ?></td>
																					<td><?php echo number_format($data->total_noncash,0,",",".") ?></td>
																					<td><?php echo number_format($data->total_cc1,0,",",".") ?></td>
																					<td><?php echo number_format($data->total_cash,0,",",".") ?></td>
																					-->
																				</tr> 
																				<?php
																					$total += $data->tarif;
