    ...
    function total_rows($q = NULL) 
		{
			$sql = "SELECT 	* 
				...
				{
					$sql .= " WHERE FALSE ";
					$sql .= "OR LOWER(nama_bank) LIKE LOWER('%".$q."%') ";
						$sql .= "OR LOWER(is_kartu_debit_kredit) LIKE LOWER('%".$q."%') ";
...
/* End of file Mst_bank_model.php */
/* Location: ./application/models/Mst_bank_model.php */
