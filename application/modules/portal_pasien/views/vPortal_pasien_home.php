...
<html>
  ...
  <?php $this->theme->wrapper_open('theme_portal_pasien','BreadCrumb'); ?>
    ...
    <div class="container mt-4">
      ...
      <hr>
      <div class="mb-3">
        <strong>Halo <?php echo html_escape($user['nama']); ?>,</strong> Selamat Datang di Portal Pasien LYND, Silahkan pilih menu yang anda inginkan
      </div>

      <div class="btn-group">
        <a class="btn btn-outline-primary" href="<?php echo base_url('portal_pasien/home'); ?>">Beranda</a>
        <a class="btn btn-outline-primary" href="<?php echo base_url('portal_pasien/booking'); ?>">Booking</a>
        <a class="btn btn-outline-primary" href="<?php echo base_url('portal_pasien/riwayat'); ?>">Riwayat Perawatan</a>
      </div>
    </div>
...
<!-- /MAIN CONTENT -->
  ...
  (function(){
    ...
    document.getElementById('btnGantiPin').addEventListener('click', async ()=>{
      ...
      alert(js.message||'OK');
		...
		document.getElementById('btnResendPin').addEventListener('click', async ()=>{
