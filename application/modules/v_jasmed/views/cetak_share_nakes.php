...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      <td colspan="7" align="center">PEMBAGIAN JASA MEDIS TENAGA KESEHATAN</td>
    </tr>
    <tr>
      <td colspan="7" align="center"><?php echo $share_nakes_header->no_jasmed ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>ID. NAKES</td>
      <td align="center">:</td>
      <td><?php echo $share_nakes_header->id_nakes ?></td>
      <td>&nbsp;</td>
      <td>TANGGAL&amp; WAKTU</td>
      <td align="center">:</td>
      <td><?php echo $share_nakes_header->waktu_jasmed ?></td>
    </tr>
    <tr>
      <td>NAMA</td>
      <td align="center">:</td>
      <td><?php echo $share_nakes_header->nakes ?></td>
      <td>&nbsp;</td>
      <td>PERIODE (DARI)</td>
      <td align="center">:</td>
      <td><?php echo date('Y-m-d',strtotime($share_nakes_header->periode_start)) ?></td>
    </tr>
    <tr>
      <td>TOTAL (Rp)</td>
      <td align="center">:</td>
      <td><?php echo number_format($share_nakes_header->total,0,",",".") ?></td>
      <td>&nbsp;</td>
      <td>PERIODE (SAMPAI)</td>
      <td align="center">:</td>
      <td><?php echo date('Y-m-d',strtotime($share_nakes_header->periode_end)) ?></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
...
<table width="100%" border="1" cellspacing="0" cellpadding="5">
  <tbody>
    ...
    <tr>
      ...
      <td align="right"><?php echo number_format($v->share_nakes,0,",",".") ?></td>
    </tr>
	<?php
		$total += $v->share_nakes;
	}
